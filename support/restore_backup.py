...
def install_function():       # Self installer program, prompts user on what they want to do
    while 1:
        ...
        print('What resources do you want to install for the {} backup?'.format(selected_backup))
        ...
        if selected_option == '3T Boot Logo':
            ...
            if not is_affirmative():
                ...
                continue
            os.system('cp {} {}'.format(BOOT_LOGO_PATH, backup_dir))  # Make Backup
            os.system('dd if={}/{}/splash of={}'.format(BACKUPS_DIR, selected_backup, BOOT_LOGO_PATH))  # Replace
            print('\nBoot Logo installed successfully! Original backed up to {}'.format(backup_dir))
            print('Press enter to continue!')
            input()
            ...
            os.system('cp {}/{}/bootanimation.zip /system/media/bootanimation.zip'.format(BACKUPS_DIR, selected_backup))  # replace
            ...
            if is_affirmative():  # Yes there is a custom OP dir
                ...
                os.system('cp {}/{}/spinner {}/selfdrive/ui/spinner'.format(BACKUPS_DIR, selected_backup, op_dir))
                ...
                os.system('cp {}/{}/spinner /data/openpilot/selfdrive/ui/spinner'.format(BACKUPS_DIR, selected_backup))
